            ...
            {typeField.value === 'Selector' ? (
                <div className="relative w-full">
                    ...
                    <div
                        {...attributes}
                        {...listeners}
                        className="absolute -left-10 top-1/2 -translate-y-1/2 cursor-grab text-gray-400 hover:text-gray-600 hover:bg-[#D9D9D9] rounded-xl p-1"
                    >
                    ...
                    >
                        ...
                        <div>
                            {typeField.value === 'Flashcard' && (
                                <div className="my-8 flex flex-col md:flex-row gap-5">
                            ...
                            {typeField.value === 'Multiple Choice Question (MCQ)' && (
                                <>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            {Array(4)
                                                .fill(0)
                                                .map((_, i) => (
                                                    <div key={i} className="flex w-full md:w-1/2 items-center gap-2">
                                                        <label className="font-semibold mb-1 block text-gray-500 shrink-0">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#0890A8] focus:border-none text-sm xs:text-base"
                                                        />
                                    ...
                                    <div className="my-8 flex flex-col xs:flex-row gap-3 xs:items-center">
                                            ...
                                            {['A', 'B', 'C', 'D'].map((label, i) => {
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`transition rounded-full flex items-center justify-center w-8 h-8 xs:w-6 xs:h-6 ${content.correct === i
                                                            ? 'border border-[#0890A8] cursor-pointer bg-[#0890A8]/10'
                                                            : isDisabled
                                                                ? 'text-gray-300 cursor-not-allowed border-gray-100 border'
                                                                : 'hover:border hover:border-[#0890A8] cursor-pointer border border-gray-200'
                                                            }`}
