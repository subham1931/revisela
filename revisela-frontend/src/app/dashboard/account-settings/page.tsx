...
import EditFieldModal from './components/edit-profile-detail';
...
const AccountSettings = () => {
  ...
  const handleUpdateProfile = (
    ...
    if (
      ...
      toast({
        ...
        description: `Your ${field} can only be changed once.`,
        type: 'error',
      });
      return;
    }
  ...
  return (
    <div className="">
        ...
        <div className="flex items-center mb-6">
          <div className="relative h-[96px] w-[96px] bg-gray-200 rounded-full flex items-center justify-center overflow-hidden">
            {profileImage ? (
              ...
              <User height={50} width={50} className="text-gray-500" />
            )}
            <input
              type="file"
              ref={fileInputRef}
            ...
            />
            <button
              className="absolute bottom-0 left-0 right-0 text-[14px] text-white bg-black bg-opacity-50 py-1 rounded-b-full"
            ...
            >
              {isUploadingImage ? (
                ...
                <span className="flex items-center justify-center text-sm mx-2">
      ...
      {/* ✅ FIXED: conditionally render modal */}
      {isPasswordModalOpen && (
        <ChangePasswordModal
